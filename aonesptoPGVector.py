# AWS Lambda function aonesptoPGVector to provide semantic search to sharepoint document stored in Postgres vector DB
...
BEDROCK_LLM_MODEL = "anthropic.claude-3-sonnet-20240229-v1:0" # LLM
...
def query_pgvector_rag(user_query: str):
    ...
    return {
        ...
        "documents_list": list(dict.fromkeys(documents)),
